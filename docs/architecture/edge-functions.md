...
| [`accounty-ai-chat`](../../supabase/functions/accounty-ai-chat/index.ts) | ❌ Nyilvános / Belső | Frontend (AiAssistantPage, Drawer, P&L, EV) | `DEEPSEEK_API_KEY / OPENAI_API_KEY, SUPABASE_URL` | eaisyBooks intelligens AI könyvelői csevegő és döntéstámogató asszisztens valós idejű SSE streaminggel és 30 req/h rate limittel ([A-104](decisions/A-104-eaisybooks-ai-chat-streaming-and-edge-architecture.md)). |
