...
async function run() {
  ...
  console.log("Assignments for Balázs Lederer:");
  assigns.forEach(a => {
    console.log(`- Company ID: ${a.company_id}, Name: ${a.companies ? a.companies.name : 'N/A'}, Firm ID: ${a.accounting_firm_id}, Role: ${a.role}, is_main: ${a.is_main_accountant}`);
  });
}
