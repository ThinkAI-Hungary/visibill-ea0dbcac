...
function deleteTable(table, query) {
  return new Promise((resolve, reject) => {
...
async function main() {
  ...
  await deleteTable('accounty_cafeteria', 'sub_type=eq.home_office');
  
  console.log("=== INSERTING VALID HOME OFFICE ROW ===");
  ...
  console.log("Valid insert result:", res);
}
