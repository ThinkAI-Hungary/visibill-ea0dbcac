...
const connectionString = "postgresql://postgres:Thinkerman11.%21@db.vxxgvdlqvvchtlmqnrqf.supabase.co:5432/postgres";
...
async function main() {
  ...
  try {
    ...
    console.log("Successfully updated acc_generate_drafts_from_ledger function with ai_recommendation and confidence fields!");
  } catch (err) {
