-- Recreate suggest_gl_mappings to fix type mismatch on varchar vs text fields
...
BEGIN
    ...
    SELECT 
        ...
        c.orig_number::TEXT AS gl_number,
        c.orig_name::TEXT AS short_name,
        pnl.pnl_id AS pnl_structure_id,
        ps.row_code::TEXT AS pnl_row_code,
        ps.name::TEXT AS pnl_row_name,
        bs.bs_id AS bs_structure_id,
        bss.row_code::TEXT AS bs_row_code,
        bss.name::TEXT AS bs_row_name,
        CASE
