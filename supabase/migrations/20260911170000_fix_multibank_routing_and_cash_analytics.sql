-- ==============================================================================
-- Migration: 20260911170000_fix_multibank_routing_and_cash_analytics.sql
-- Description:
--   1. Multi-bank routing: In acc_generate_drafts_from_ledger, resolve bank journal
--      by matching transaction_uploads.detected_bank / bank_hint with acc_journals (type=BANK).
--   2. Petty cash resolution: Resolve v_gl_cash_id using P1 journal connected_gl_account
--      first, with analytical fallback preferring 3811 over parent 381.
-- ==============================================================================
