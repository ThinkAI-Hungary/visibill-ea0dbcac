-- =============================================================================
-- Migration: Create get_management_files RPC
-- Description: High-performance unified query for management files across
--              invoice_uploads, transaction_uploads, bank_statement_uploads,
--              and report_uploads with accurate KPI counts and pagination.
-- =============================================================================
...
BEGIN
  ...
  -- Create temporary table to hold base filtered rows (without status filter) for stats and pagination
