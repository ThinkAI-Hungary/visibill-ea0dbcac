-- Migration: 20260918001000_atomic_settle_invoices_via_petty_cash.sql
-- Description: Atomic settlement of outbound invoices via petty cash in a single ACID transaction
...
BEGIN
  ...
  SELECT 
    COUNT(*),
    COALESCE(SUM(brutto_vegosszeg), 0),
...
-- Safeguard trigger against deleting manual invoice settlements
