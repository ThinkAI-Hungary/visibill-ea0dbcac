-- Migration: Simplify Petty Cash description format for cash vouchers
-- Created at: 2026-07-16

-- 1. Re-define sync_petty_cash_entries to simplify cash voucher descriptions
...
BEGIN
  ...
  -- DESCRIPTION simplified to: 'Pénztári bevétel - ' || vevo_nev
  INSERT INTO petty_cash_entries (company_id, register_id, entry_date, description, amount, currency, source_type, source_id, source_table, routed_by)
  SELECT
    p_company_id,
    v_default_register_id,
  ...
  -- DESCRIPTION simplified to: 'Pénztári kiadás - ' || elado_nev
  INSERT INTO petty_cash_entries (company_id, register_id, entry_date, description, amount, currency, source_type, source_id, source_table, routed_by)
  SELECT
    p_company_id,
    v_default_register_id,
...
-- 2. Re-define sync_petty_cash_on_invoice_change trigger function
