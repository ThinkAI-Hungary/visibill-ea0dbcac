-- =============================================
-- Migration: Support Annual VAT returns (frequency = 'E')
-- =============================================

-- 1. Drop existing frequency check constraint and recreate to allow 'E'
ALTER TABLE public.vat_returns DROP CONSTRAINT IF EXISTS vat_returns_frequency_check;
ALTER TABLE public.vat_returns ADD CONSTRAINT vat_returns_frequency_check CHECK (frequency IN ('H', 'N', 'E'));

-- 2. Recreate calculate_vat_return function with support for 'E' (Annual)
