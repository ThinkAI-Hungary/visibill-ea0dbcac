-- Migration: 20260923230000_fix_acc_generate_drafts_petty_cash_column.sql
-- Description:
--   Fix fatal 42703 error in acc_generate_drafts_from_ledger by removing non-existent
--   column p.is_opening in the petty_cash_entries cursor query.
--   Petty cash opening entries are already correctly filtered via source_type <> 'opening_balance'.
