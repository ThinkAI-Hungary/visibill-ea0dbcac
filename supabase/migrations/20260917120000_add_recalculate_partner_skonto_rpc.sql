-- Migration: 20260917120000_add_recalculate_partner_skonto_rpc.sql
-- Description: Server-side atomic partner skonto recalculation for open unpaid inbound invoices.
--              Replaces sequential client-side loops in PartnersPage with an atomic, transactional RPC.
