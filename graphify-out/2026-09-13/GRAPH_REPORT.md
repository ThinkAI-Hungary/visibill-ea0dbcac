...
## Corpus Check
- 1973 files · ~2,594,818 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17115 nodes · 30443 edges · 1205 communities (1063 shown, 142 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 41 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c26163f3`
...
## Communities (1205 total, 142 thin omitted)
...
Cohesion: 0.03
Nodes (157): categoryConfig, statusConfig, TabType, ViewMode, EVENT_COLORS, EVENT_LABELS, EVENT_TYPES, COLORS (+149 more)
...
Cohesion: 0.10
Nodes (34): FALLBACK_CATEGORY_MAP, FALLBACK_KNOWLEDGE_ARTICLES, FALLBACK_KNOWLEDGE_CATEGORIES, useCanAccessKnowledgeMenuPath(), useDebounce(), useKnowledgeArticle(), useKnowledgeArticles(), useKnowledgeCategories() (+26 more)
...
Cohesion: 0.05
Nodes (56): DEFAULTS, OfficeSettings, Tab, AiAssistantChat(), AiAssistantChatProps, CompanySelectToken, ConversationSidebar(), Message (+48 more)
...
Cohesion: 0.02
Nodes (120): AccountyErrorState(), AccountyErrorStateProps, FeatureCard(), ClientInvoicesPage(), ClientReportsPage(), ReportType, reportTypes, EmployeeExitWizardPage() (+112 more)
...
Cohesion: 0.08
Nodes (51): ClientPortalPage(), ExitDocumentsPage(), FILING_TYPES, FilingsPage(), MONTHS, STATUS_MAP, PayrollDashboardPage(), fmt() (+43 more)
...
Cohesion: 0.08
Nodes (32): CompanySwitcher(), useSafeCompany(), useAccountyAccountants(), InvoiceItemsDialogProps, InvoiceLineItem, ItemNoteCell(), ItemNoteCellProps, ItemProjectRuleButtonProps (+24 more)
...
Cohesion: 0.07
Nodes (29): ClientDeadline, DeadlineGroup, deadlineTypeTitle, Status, ACTION_CONFIG, ActivityLogSheet(), AuditLogRow, AVAILABLE_ACTIONS (+21 more)
...
Cohesion: 0.05
Nodes (87): AccountyApp(), AccountyShellProvider(), useSafeCompany(), RecentActivities(), CompanyStructurePage(), DataRetentionPage(), REQUEST_TYPE_LABELS, calculateInsurance() (+79 more)
...
Cohesion: 0.08
Nodes (29): ExportButton(), ExportButtonProps, Deadline, NavDeadlinesPage(), STATUS_OPTIONS, TYPE_CONFIG, DeclarationArchivePage(), STATUS_BADGE (+21 more)
...
Cohesion: 0.04
Nodes (116): InvoiceImagePreview(), InvoiceImagePreviewProps, signedUrlCache, LanguageSwitcherProps, Project, ProjectFlowchartProps, fmtHuf(), SUB_ACCOUNT_CONFIG (+108 more)
...
Cohesion: 0.03
Nodes (73): BalanceSheetWidgets(), GlobalDatePicker(), formatDate(), formatDateTime(), FullInvoice, InvoiceDetailPopup(), InvoiceDetailPopupProps, statusLabels (+65 more)
...
Cohesion: 0.05
Nodes (40): 05 — Layout & Navigáció, 1. Hidegindítás (Cold Start – F5 újratöltés vagy munkamenetbeli első belépés), 1. Scrollbar Gutter — `scrollbar-gutter: stable`, 2. CSS Grid gyerekek — `min-h-0` kötelező, 2. Meleg Váltás (Warm Switch – további navigációk az appok között), 3. Cégválasztó & Útvonal Szinkronizáció, 3. `divide-y` és `border-l-*` NEM kombinálható, 4. Aktív állapot border — mindig foglalj helyet (+32 more)
...
Cohesion: 0.04
Nodes (84): FirmMembersCard(), Profile, SystemSettings, CategoryCard(), CourierReportTabProps, MatchDetails, REPORT_LABELS, STATUS_CONFIG (+76 more)
...
Cohesion: 0.03
Nodes (77): AccountingRedirectPage(), FUND_TYPES, Props, CATEGORIES, PRIORITIES, Props, STATUSES, Props (+69 more)
...
Cohesion: 0.07
Nodes (41): BankHintSelector(), BankHintSelectorProps, CourierTypeSelector(), CourierTypeSelectorProps, UploadChannelTab(), UploadChannelTabProps, BANK_HINT_OPTIONS, CHANNEL_CONFIGS (+33 more)
...
Cohesion: 0.07
Nodes (33): AccountyScopedLayout(), accountyPrefetchMap, AccountyShellContextType, createDefaultAccountyShellContext(), extractCompanyIdFromPath(), SHELL_CONTEXT_KEY, SubGroup, SubGroupItem (+25 more)
...
Cohesion: 0.03
Nodes (76): ACTION_META, ClientDetailsPage(), DEFAULT_META, ClientMissingInvoicesPage(), ClientMissingInvoicesReportPage(), MissingInvoicesReportPage(), TaxCalendarPage(), AssignmentRow (+68 more)
...
Cohesion: 0.06
Nodes (39): Child, FamilyDeclarationPage(), TAX_PARAMS_2026, CONFIGS, DeclType, GenericDeclarationPage(), EmployeeCafeteriaTab(), EmployeeCafeteriaTabProps (+31 more)
...
Cohesion: 0.02
Nodes (221): EvPortfolioDashboard, PayrollPortfolioPage, TaoPortfolioPage, Props, State, AccountyLayout(), AccountyLayoutInner(), AccountyRoleContext (+213 more)
...
Cohesion: 0.09
Nodes (23): ACCOUNTY_ADMIN_ONLY, ACCOUNTY_ALWAYS_ACCESSIBLE, ACCOUNTY_SENIOR_MODULES, AccountyModule, AccountyRole, ADMIN_ONLY_MODULES, ALL_MODULES, ASSISTANT_MODULES (+15 more)
...
Cohesion: 0.08
Nodes (48): EmployeeDetailsPage(), TABS, DECLARATION_TYPES, EditDeclarationDialog(), NewDeclarationDialog(), selectStyle, EmployeeDeclarationsTab(), EmployeeDeclarationsTabProps (+40 more)
...
Cohesion: 0.06
Nodes (34): calendar, click_day_hint, desc, due_on_day, items_count, no_bank_account, select_all, title (+26 more)
...
Cohesion: 0.03
Nodes (159): DEFAULTS, FormData, KauType, TarhelyType, Props, State, NylasEmailConnectProps, NylasToken (+151 more)
...
Cohesion: 0.16
Nodes (16): InvoiceBulkActionsBar(), InvoiceContext, useInvoiceContext(), InvoiceDialogManager(), InvoiceTabSelector(), InvoiceHeader(), InvoiceKpiCards(), InvoicesFeature() (+8 more)
...
Cohesion: 0.09
Nodes (36): Ticket, TicketComment, TicketEvent, TicketPriority, TicketStatus, TicketType, useAddComment(), useDeleteTicket() (+28 more)
...
Cohesion: 0.12
Nodes (19): ADMIN_ONLY_MODULES, ALL_MODULES, ASSISTANT_MODULES, canAccess(), canWrite(), EMPLOYEE_MODULES, MEMBER_MODULES, SHIPMENT_MODULES (+11 more)
...
Cohesion: 0.10
Nodes (31): HtmlPreviewAdapter, DocumentEngine, downloadBlob(), DownloadOptions, downloadString(), CustomHtmlSection, DocumentDescriptor, DocumentMetadata (+23 more)
...
Cohesion: 0.14
Nodes (14): getLocalizedGlAccountName(), CODE_TO_KEY, getLocalizedJournalName(), HU_NAME_TO_KEY, JournalLike, LocalizeJournalOptions, normalizeName(), SHORT_CODE_TO_KEY (+6 more)
...
Cohesion: 0.22
Nodes (8): AccountyApp, AccountyLegacyClientRedirect(), AccountyRootRedirect(), Index, LegacyRedirect(), MissingInvoicesLegacyRedirect(), PayrollLegacyRedirect(), RootRedirect()
...
Cohesion: 0.10
Nodes (24): CYCLE_STEPS, EMPLOYMENT_TYPE_LABELS, MONTHS, PayrollCyclePage(), PayrollCalculation, useCreateCycle(), usePayrollItems(), useRunBatchPayroll() (+16 more)
...
Cohesion: 0.29
Nodes (4): NettingCardSectionProps, ExpandedInvoiceRowProps, NettingGroup, useNettingDetection()
...
Cohesion: 0.08
Nodes (33): useCompanyInvoices(), CashbookCloseWizard(), CloseCheck, MONTH_LABELS, PeriodSummary, runCloseChecks(), WizardStep, CashbookLedgerView() (+25 more)
...
## Knowledge Gaps
- **11303 isolated node(s):** `__filename`, `__dirname`, `rootDir`, `envLocalPath`, `envVars` (+11298 more)
...
- **What connects `__filename`, `__dirname`, `rootDir` to the rest of the system?**
  _11310 weakly-connected nodes found - possible documentation gaps or missing edges._
