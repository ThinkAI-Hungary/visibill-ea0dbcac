...
## Corpus Check
- 1150 files · ~1,797,578 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6322 nodes · 14576 edges · 475 communities (354 shown, 121 thin omitted)
...
## Communities (475 total, 121 thin omitted)
...
Cohesion: 0.08
Nodes (41): ExportButtonProps, Deadline, NavDeadlinesPage(), STATUS_OPTIONS, TYPE_CONFIG, useTransfers(), CONFIGS, DocConfig (+33 more)
...
Cohesion: 0.06
Nodes (61): AnimatedNumber(), KpiModalType, COLORS, MONTH_NAMES_HU, Category, EditableLineItem, InvoiceFullEditDialogProps, InvoiceLineItem (+53 more)
...
Cohesion: 0.12
Nodes (18): CompanyPayrollSettingsPage(), DEFAULT_SETTINGS, PayrollSettings, Tab, TABS, EmployeeExitWizardPage(), EXIT_DOCS, REASONS (+10 more)

### Community 13 - "Accounty Generaterequestemail Generatedemail"
Cohesion: 0.08
Nodes (30): Action, ActionType, actionTypes, addToRemoveQueue(), dispatch(), genId(), listeners, memoryState (+22 more)

### Community 14 - "Accounty Generaterequestemail Generateemailparams"
Cohesion: 0.17
Nodes (23): PayrollCalculation, calculatePremiums(), DEFAULT_PREMIUM_RATES, monthlyToHourly(), OvertimeTrackerResult, PremiumInput, PremiumItem, PremiumRates (+15 more)

### Community 15 - "Accounty Generaterequestemail Generaterequestemail"
Cohesion: 0.08
Nodes (23): ACTION_CONFIG, AuditLogRow, AVAILABLE_ACTIONS, CompanyMember, CURRENT_YEAR, DAY_OPTIONS, ENTITY_CONFIG, HOUR_OPTIONS (+15 more)
...
Cohesion: 0.09
Nodes (32): ACTION_META, ClientDetailsPage(), DEFAULT_META, RecentActivities(), ClientInvoicesPage(), ClientMissingInvoicesPage(), ClientMissingInvoicesReportPage(), COLORS (+24 more)
...
Cohesion: 0.05
Nodes (64): AccountyWelcomeWizard(), AdminTaxParametersPage(), PARAM_LABELS, AuditLogPage(), EVENT_COLORS, EVENT_LABELS, EVENT_TYPES, GdprPage() (+56 more)
...
Cohesion: 0.07
Nodes (57): useAccountyClient(), EvChamberPage(), ENGINE_LABELS, EvCompanyCarTaxPage(), DetailRow(), EvComparePage(), FORM_COLORS, FORM_ICONS (+49 more)

### Community 23 - "Accounty Generaterequestemail Updatemessagestatus"
Cohesion: 0.01
Nodes (138): CompanyProvider(), ThemeProvider(), AccountantManagementPage, AccountyLayout, AccountyOnboardingPage, AdminTaxParametersPage, AiAnomalyReportPage, AiAssistantPage (+130 more)
...
Cohesion: 0.24
Nodes (17): Ticket, TicketComment, TicketType, useAddComment(), useDeleteTicket(), useIsManagementRole(), useIsSupportAdmin(), useMarkTicketRead() (+9 more)
...
Cohesion: 0.13
Nodes (22): calculateInsurance(), MultiJobPage(), AccountyDocument, EmployeeJob, Filing, Transfer, useAccountyDocuments(), useAddDeclaration() (+14 more)

### Community 30 - "Accounty Types Blockingitem"
Cohesion: 0.09
Nodes (39): formatValue(), InvoiceStatusTables(), useActivePreset(), ExchangeRatesResponse, useExchangeRates(), KeyCombo, ShortcutHandler, useKeyboardShortcuts() (+31 more)
...
Cohesion: 0.06
Nodes (60): Filter, AssetActivationDialogProps, InvoiceInfo, SelectedItem, CategoryCardProps, ALLOWED_IMAGE_TYPES, FeedbackDialogProps, IdleWarningModalProps (+52 more)
...
Cohesion: 0.21
Nodes (20): ApprovalQueuePage(), categoryConfig, statusConfig, TabType, ViewMode, addToApprovalQueue(), categoryLabels, fireApprovalNotification() (+12 more)
...
Cohesion: 0.16
Nodes (15): DateRangeProvider(), formatDate(), getInitialDates(), decodeHtmlEntities(), getAvatarColor(), getInitials(), displayTaxNumber(), getInitials() (+7 more)
...
Cohesion: 0.08
Nodes (49): ProfileSettingsPage(), EmailAliasManager(), FeedbackDialog(), InvoiceItemsDialog(), SupportModeBanner(), UploadedFilesModal(), UploadHistory(), useCompany() (+41 more)
...
Cohesion: 0.05
Nodes (77): InvoiceItemsDialogProps, InvoiceLineItem, TransactionReasonCell(), TransactionReasonCellProps, DateRangeContext, DateRangeContextType, NavInvoice, Partner (+69 more)
...
Cohesion: 0.04
Nodes (83): Profile, SystemSettings, Props, State, SUB_ACCOUNT_CONFIG, UnsavedChangesDialog(), InvoiceStatusTablesSkeleton(), MetricsGridSkeleton() (+75 more)
...
Cohesion: 0.03
Nodes (66): FeatureCard(), ExpandedInvoiceRow(), InlineTransactionList(), FeedbackFabProps, SpeedDialFab(), MetricCard(), CONFIGS, DeclType (+58 more)
...
Cohesion: 0.29
Nodes (10): ClientDeadline, DeadlineGroup, deadlineTypeTitle, KpiCard(), Status, TaxCalendarPage(), useAccountyDeadlines(), useCompleteDeadline() (+2 more)
...
Cohesion: 0.06
Nodes (46): ACCOUNTY_ADMIN_ONLY, ACCOUNTY_ALWAYS_ACCESSIBLE, ACCOUNTY_SENIOR_MODULES, AccountyModule, AccountyRole, ADMIN_ONLY_MODULES, ALL_MODULES, ASSISTANT_MODULES (+38 more)
...
Cohesion: 0.07
Nodes (34): LinkedInvoice, MatchedCourierReport, MatchedNavInvoice, MatchedSubmittedInvoice, MatchedTransaction, formatDate(), formatDateTime(), FullInvoice (+26 more)
...
Cohesion: 0.05
Nodes (44): AccountyLayoutInner(), AccountyRole, AccountyRoleContext, AccountyRoleContextType, AccountyRoleProvider(), useAccountyRole(), CompanySwitcher(), AccountantUser (+36 more)
...
Cohesion: 0.36
Nodes (8): ClientReportsPage(), ReportType, reportTypes, NewClientPage(), ClientReportsPage, NewClientPage, RadioGroup, RadioGroupItem

### Community 152 - "Hooks Usepayrolldata Batchpayrollresult"
Cohesion: 0.10
Nodes (20): AccountyLayout(), ProductTour(), ProductTourProps, TOUR_STEPS, ProductTourTooltip(), Theme, ThemeContext, ThemeContextType (+12 more)

### Community 170 - "Community 170"
Cohesion: 0.24
Nodes (8): FeedbackFab(), isUploadNotified(), LiveNotificationProvider(), _notifiedUploadIds, _pendingSessionUploads, registerPendingUpload(), ProtectedLayout(), useAppReady()

### Community 171 - "Community 171"
Cohesion: 0.04
Nodes (89): AccountyErrorState(), AccountyErrorStateProps, Alert, AlertCategory, AlertLevel, AlertsCenterPage(), AlertState, CATEGORIES (+81 more)
...
Cohesion: 0.08
Nodes (22): getStatus(), DeadlineStatus, EvCalendarPage(), MONTH_NAMES, RETURN_TYPE_MAP, STATUS_ICON, TYPE_COLORS, TYPE_LABELS (+14 more)
...
Cohesion: 0.05
Nodes (39): A-019: Management Dashboard Architektúra, Adatforrások, API Design: Action-based Query Params, Architektúra, Architektúra: Edge Function + Service Role, Aszinkron URL Állapot Szinkronizáció & Pagináció, Consequences, Context (+31 more)
...
Cohesion: 0.04
Nodes (33): COL_LABELS, CompanyDetail, ControlCenterTab, ControlCenterUser, ErrorControlPanel(), ErrorRow, ErrorsData, ErrorSortCol (+25 more)
...
Cohesion: 0.11
Nodes (25): ReportsPage(), ReportType, reportTypes, FullReportData, InvoiceReportRow, ReportRow, ReportCatalog(), ReportCatalogProps (+17 more)
...
Cohesion: 0.11
Nodes (44): CompanyStructurePage(), DataRetentionPage(), REQUEST_TYPE_LABELS, PortalStats, InvoiceStatus, useAccountyPortalTokens(), CostCenter, DataContract (+36 more)
...
Cohesion: 0.07
Nodes (28): MissingInvoicesReportPage(), CompanyInvoice, AccountyAccountant, AccountyCommunicationPrefs, AccountyCompanySummary, AccountyDeadline, AccountyKpis, AccountyMissingItem (+20 more)
...
Cohesion: 0.05
Nodes (43): Props, State, AccountyWelcomeWizardProps, CMRDocData, CMREscalationDialogProps, SiblingUpload, UploadRecord, EmailAlias (+35 more)
...
Cohesion: 0.07
Nodes (37): CASHBOOK_CATEGORIES, CashbookEntryForm(), CashbookEntryFormData, CashbookEntryFormProps, CategoryNode, EntryDirection, FLAT_CATEGORIES, KATA_ALLOWED_CATEGORIES (+29 more)
...
Cohesion: 0.38
Nodes (5): CATEGORIES, PARAM_LABELS, TaxParametersPage(), useTaxParameters(), useUpdateTaxParameter()
...
Cohesion: 0.11
Nodes (19): CompanySelector(), fmtHuf(), SzepCardTab(), useDateRange(), UnmatchedSection(), useCourierReportData(), useDashboardData(), CHART_LINE_DEFAULTS (+11 more)

### Community 443 - "Community 443"
Cohesion: 0.05
Nodes (59): AccountyApp(), PrivacyConsent, PrivacyPolicyPage(), sections, FirmMembersCard(), SettingsTab, useAccountyAuditLog(), useAccountyPortalStats() (+51 more)
...
Cohesion: 0.09
Nodes (28): EmployeeWizardPage(), EMPLOYMENT_TYPES, FormData, FormField(), INITIAL_FORM, STEPS, CourierInvoiceDialog(), CourierReportTab() (+20 more)

### Community 446 - "Community 446"
Cohesion: 0.40
Nodes (4): Child, FamilyDeclarationPage(), TAX_PARAMS_2026, useAddDeclaration()
...
Cohesion: 0.14
Nodes (23): useAccountyAccountants(), Partner, PartnerCombobox(), PartnerComboboxProps, CLIENT_COLORS, KpiCard(), OwnerDropdown(), GeneralLedgerTable (+15 more)
...
## Knowledge Gaps
- **3198 isolated node(s):** `entrypoint_path`, `name`, `files`, `verify_jwt`, `{ createClient }` (+3193 more)
...
- **Why does `cn()` connect `Hooks Useaccountydata Useresolvemissingitem` to `Email Processing Ecosystem`, `Invoice Type Definitions`, `Accounty Accountyrolecontext Useaccountyrole`, `Accounty Clientinvoicespage Clientinvoicespage`, `Accounty Generaterequestemail Addtoapprovalqueue`, `Accounty Generaterequestemail Generaterequestemail`, `Accounty Generaterequestemail Messagecategory`, `Accounty Generaterequestemail Messagestatus`, `Accounty Generaterequestemail Missingitemforemail`, `Accounty Generaterequestemail Updatemessagebody`, `Accounty Types Blockingcategory`, `Accounty Types Blockingitem`, `Components Emailpreferences Emailpreferences`, `Components Feedbackfab Feedbackfab`, `Components Producttour Producttour`, `Contexts Companycontext Company`, `Contexts Themecontext Usetheme`, `Dashboard Useractivitydialog Useractivitydialog`, `Eaisybill Prod Readme`, `Fixed Assets Depreciationcards Depreciationcards`, `General Ledger Uploadchartofaccountsmodal Uploadch`, `Hooks Useaccountydata Accountyaccountant`, `Hooks Useaccountydata Accountyclient`, `Hooks Useaccountydata Auditlogentry`, `Hooks Useaccountydata Colleaguestat`, `Hooks Useaccountydata Companyinvoice`, `Hooks Useaccountydata Monthlytrendpoint`, `Hooks Useaccountydata Useaccountyauditlog`, `Hooks Useaccountydata Useaccountyportalstats`, `Hooks Useaccountydata Useupdatekanbanstatus`, `Hooks Useaccountydata Useupsertcommunicationprefs`, `Hooks Useaccountydata Useupserttaxprofile`, `Hooks Useappready Redirecttarget`, `Hooks Usedashboarddata Monthlydata`, `Hooks Useidletimeout Useidletimeout`, `Hooks Useleaverequests Leavestatus`, `Hooks Usepayrolldata Batchpayrollinput`, `Hooks Usepayrolldata Batchpayrollresult`, `Community 171`, `Community 174`, `Community 175`, `Community 177`, `Community 212`, `Community 216`, `Community 242`, `Community 323`, `Community 327`, `Community 332`, `Community 339`, `Community 343`, `Community 351`, `Community 358`, `Community 364`, `Community 374`, `Community 386`, `Community 391`, `Community 407`, `Community 411`, `Community 415`, `Community 419`, `Community 421`, `Community 431`, `Community 433`, `Community 439`, `Community 441`, `Community 443`, `Community 444`, `Community 445`, `Community 446`, `Community 448`, `Community 449`, `Community 453`, `Community 457`, `Community 460`, `Community 462`, `Community 478`, `Community 482`?**
...
- **What connects `entrypoint_path`, `name`, `files` to the rest of the system?**
  _3205 weakly-connected nodes found - possible documentation gaps or missing edges._
