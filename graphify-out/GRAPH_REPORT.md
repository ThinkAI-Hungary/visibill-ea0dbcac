# Graph Report - eaisybill-prod  (2026-09-24)

## Corpus Check
- 2244 files · ~2,971,604 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21040 nodes · 35935 edges · 1432 communities (1281 shown, 151 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 45 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `322ad231`
...
1. `cn()` - 598 edges
2. `Button` - 350 edges
3. `useToast()` - 333 edges
4. `supabase` - 283 edges
5. `useAuth()` - 267 edges
6. `useCompany()` - 238 edges
...
## Communities (1432 total, 151 thin omitted)
...
Cohesion: 0.03
Nodes (92): EvPortfolioDashboard, PayrollPortfolioPage, TaoPortfolioPage, Props, State, AccountyLayout(), AccountyLayoutInner(), useAccountyRole() (+84 more)
...
Cohesion: 0.12
Nodes (24): fetchManagementData(), postManagementData(), RETRYABLE_SOURCES, useWorkerTelemetry(), WORKER_PERIOD_LABELS, formatDuration(), formatUptime(), LLMCostPanel() (+16 more)
...
Cohesion: 0.04
Nodes (54): mockHandleBackToPortfolio, mockNavigate, mockShellContext, AccountyScopedLayout(), accountyPrefetchMap, AccountyShellContextType, createDefaultAccountyShellContext(), extractCompanyIdFromPath() (+46 more)
...
Cohesion: 0.06
Nodes (62): ClientMissingInvoicesReportPage(), COLORS, defaultBarData, defaultPieData, ClientPortalPage(), EmployeesPage(), ExitDocumentsPage(), ExportButton() (+54 more)

### Community 15 - "Accounty Generaterequestemail Generaterequestemail"
Cohesion: 0.03
Nodes (70): AiAssistantChat(), AiAssistantChatProps, CompanySelectToken, ConversationSidebar(), Message, QUICK_ACTIONS, MessageFeedbackWidget, MessageFeedbackWidgetProps (+62 more)
...
Cohesion: 0.02
Nodes (121): AccountantManagementPage, AccountingRedirectPage, AccountyOnboardingPage, AccountyScopedLayout, AdminTaxParametersPage, AiAnomalyReportPage, AiAssistantPage, AlertsCenterPage (+113 more)
...
Cohesion: 0.07
Nodes (62): DateRangeContext, DateRangeContextType, DateRangeProvider(), formatDate(), getInitialDates(), parseLocalDate(), ClientEvMainPage(), EMPLOYMENT_LABELS (+54 more)

### Community 23 - "Accounty Generaterequestemail Updatemessagestatus"
Cohesion: 0.08
Nodes (44): EmployeeDetailsPage(), TABS, DECLARATION_TYPES, EditDeclarationDialog(), NewDeclarationDialog(), EmployeeDeclarationsTab(), EmployeeDeclarationsTabProps, EditField() (+36 more)
...
Cohesion: 0.05
Nodes (82): AccountyApp(), RecentActivities(), CompanyStructurePage(), DataRetentionPage(), REQUEST_TYPE_LABELS, calculateInsurance(), MultiJobPage(), RepresentationPage() (+74 more)
...
Cohesion: 0.04
Nodes (76): CegkapuSettingsPage(), ACTION_KEY_MAP, ACTION_META, ClientDetailsPage(), DEADLINE_TITLES_HR, DEADLINE_TYPES_HR, DEFAULT_META, ClientMissingInvoicesPage() (+68 more)
...
Cohesion: 0.14
Nodes (27): usePageDeductibilityMap(), UsePageDeductibilityMapProps, BuyerMismatchResult, checkBuyerTaxMismatch(), evaluateNavAndSubmittedSuggestedMatch(), ExtendedNavInvoiceMatchCandidate, ExtendedSubmittedInvoiceMatchCandidate, extractBaseTax() (+19 more)
...
Cohesion: 0.14
Nodes (17): InvoiceBulkActionsBar(), InvoiceContext, useInvoiceContext(), BulkDeleteDialog(), InvoiceDialogManager(), InvoiceTabSelector(), InvoiceHeader(), InvoiceKpiCards() (+9 more)
...
Cohesion: 0.05
Nodes (71): AccountingRedirectPage(), useAccountyClient(), useAccountyCommunicationPrefs(), getStatus(), useDateRange(), CashbookMainPage(), EvCashbookImportNavPage(), ENGINE_LABELS (+63 more)
...
Cohesion: 0.03
Nodes (92): useCompanyInvoices(), FUND_TYPES, Props, CATEGORIES, PRIORITIES, Props, STATUSES, Props (+84 more)
...
Cohesion: 0.12
Nodes (27): OverviewTabProps, BulkImportResult, ReconstructionResult, PayrollCycle, PayrollEmployee, PayrollEmployment, PayrollLeave, LeaveBalance (+19 more)
...
Cohesion: 0.02
Nodes (137): ClientInvoicesPage(), ClientReportsPage(), CompanySwitcher(), useSafeCompany(), EmployeeImportPage(), NewClientPage(), CycleStatusBadge(), KpiCard() (+129 more)
...
Cohesion: 0.07
Nodes (27): CYCLE_STEPS, EMPLOYMENT_TYPE_LABELS, MONTHS, PayrollCyclePage(), EmployeeCafeteriaTab(), EmployeeCafeteriaTabProps, BatchPayrollInput, BatchPayrollResult (+19 more)
...
Cohesion: 0.11
Nodes (18): CategoryAccordionItem(), CategoryAccordionItemProps, formatCurrencyTotals(), CategoryAmountStat, CategoryAmountSummary(), CategoryAmountSummaryProps, CATEGORY_COLORS, CategoryDonutChart() (+10 more)
...
Cohesion: 0.17
Nodes (12): CustomTooltip(), fmtCurrencySigned(), fmtMonth(), FxDifferenceRow, FxDifferencesSection, FxDifferencesSectionProps, FxGlSettings, FxMonthlySummary (+4 more)
...
Cohesion: 0.10
Nodes (37): CafeteriaAllocation, CafeteriaTaxResult, CafeteriaWarning, calculateCafeteriaTax(), calculatePocketTax(), DEFAULT_2026_SZEP_LIMITS, formatCafeteriaSummary(), SzepCardLimits (+29 more)
...
Cohesion: 0.16
Nodes (12): BlockingCategory, blockingCategoryMeta, BlockingItem, ClientData, BlockingCategory, blockingCategoryMeta, BlockingItem, ClientData (+4 more)
...
Cohesion: 0.33
Nodes (7): buildVatReturnXml(), convertToEFt(), generateVatReturnXml(), getVatReturnFilename(), getVatReturnXmlString(), VatInvoiceDetail, XmlExportData
...
Cohesion: 0.06
Nodes (33): reclassify_btn, selected_count, general_ledger, balance_label, breadcrumb, bulk, closing_balance, date_label (+25 more)
...
Cohesion: 0.02
Nodes (220): TabType, ViewMode, ReportType, reportTypes, DOCUMENT_TEMPLATES, ExitDocument, STATUS_BADGE, STATUS_CONFIG (+212 more)
...
Cohesion: 0.05
Nodes (43): reclassify_btn, selected_count, collapse_all, expand_all, refresh, refreshing, general_ledger, balance_label (+35 more)
...
Cohesion: 0.03
Nodes (220): DEFAULTS, FormData, KauType, TarhelyType, BULK_STATUS_OPTIONS, SAMPLE_ROWS, TEMPLATE_HEADERS, KpiModalType (+212 more)
...
Cohesion: 0.16
Nodes (15): VatA60TableProps, VatMLineDrillDown(), VatMLineDrillDownProps, VatXmlValidationDialogProps, A60CalculationsResult, DeadlineInfo, FormRow, MLine (+7 more)
...
Cohesion: 0.02
Nodes (210): Props, preloadControlCenterPanel(), NylasEmailConnectProps, NylasToken, Partner, PartnerComboboxProps, TransactionReasonCell(), TransactionReasonCellProps (+202 more)
...
Cohesion: 0.06
Nodes (55): AccountyWelcomeWizard(), AdminTaxParametersPage(), formatValue(), PARAM_LABELS, AuditLogPage(), EVENT_COLORS, EVENT_LABELS, EVENT_TYPES (+47 more)
...
Cohesion: 0.19
Nodes (12): PdfDocumentAdapter, loadPdfLibraries(), CustomHtmlSection, DocumentMetadata, DocumentSection, DocumentType, ExportResult, KeyValueSection (+4 more)
...
Cohesion: 0.02
Nodes (270): AccountantManagementPage(), AssignCompanyDialog(), AvailableCompany, FirmAccountant, ROLE_COLORS, ROLE_LABELS, useAddCompanyAssignment(), useFirmAccountants() (+262 more)
...
Cohesion: 0.13
Nodes (20): HtmlPreviewAdapter, SpreadsheetAdapter, XmlDocumentAdapter, DocumentEngine, createPreviewBlobUrl(), downloadBlob(), DownloadOptions, downloadString() (+12 more)
...
Cohesion: 0.09
Nodes (24): ExportButtonProps, Deadline, NavDeadlinesPage(), STATUS_OPTIONS, TYPE_CONFIG, Declaration, useDeclarations(), DeclarationArchivePage() (+16 more)
...
Cohesion: 0.06
Nodes (47): ChatMessage, MONTHS, PAYROLL_REQUEST_CATALOG, PortalRequest, isUploadNotified(), LiveNotificationProvider(), _notifiedUploadIds, _pendingSessionUploads (+39 more)
...
Cohesion: 0.08
Nodes (45): Ticket, TicketComment, TicketEvent, TicketPriority, TicketStatus, TicketType, useAddComment(), useDeleteTicket() (+37 more)
...
Cohesion: 0.15
Nodes (14): Aggreg8BankConnections(), Aggreg8Account, Aggreg8Consent, useAggreg8(), UseAggreg8Props, formatAccountOnType(), BANK_GRADIENTS, BankAccount (+6 more)
...
Cohesion: 0.05
Nodes (33): AppLayout(), AppLayoutProps, ContentArea, TopBar, useIdleRoutePrefetch(), AppSidebar, useIsMobile(), sidebarMountSpy (+25 more)
...
Cohesion: 0.28
Nodes (6): unsubscribeFromPush(), urlBase64ToUint8Array(), AccountyNotificationPreferences(), DigestPrefs, EmailNotifPrefs, PushNotifPrefs
...
Cohesion: 0.09
Nodes (21): columns, category, currency, due_date, fulfillment_date, gross_amount, invoice_number, issue_date (+13 more)

### Community 1195 - "Community 1195"
Cohesion: 0.18
Nodes (18): formatAmount(), NavInvoiceVatSummaryCard(), NavInvoiceVatSummaryCardProps, InvoiceLineItem, InvoiceSummaryDetails, InvoiceVatSummaryItem, TaxpayerAddress, VatRateCategory (+10 more)
...
Cohesion: 0.15
Nodes (20): InvoiceProvider(), InvoiceApprovalDialogProps, SuggestedInvoiceLinkDialogProps, CourierReportRecord, NavInvoice, SubmittedInvoice, TransactionRecord, useInvoiceData() (+12 more)
...
Cohesion: 0.22
Nodes (7): AccountyRole, hasMinimumRole(), ProtectedAccountyRoute(), ProtectedAccountyRouteProps, ROLE_HIERARCHY, AccountyRole, ROLE_PRIORITY
...
Cohesion: 0.05
Nodes (39): AccountyErrorState(), AccountyErrorStateProps, CompanyPayrollSettingsPage(), DEFAULT_SETTINGS, PayrollSettings, Tab, TABS, EmployeeExitWizardPage() (+31 more)
...
## Knowledge Gaps
- **14392 isolated node(s):** `skill_name`, `evals`, `__filename`, `__dirname`, `rootDir` (+14387 more)
...
- **Why does `general_ledger` connect `Community 821` to `Community 1421`, `Community 659`, `Accounty Mockdata Blockingcategory`, `Community 1305`, `Community 669`, `Community 1055`, `Community 1190`, `Community 1192`, `Community 1068`, `Community 813`, `Community 942`, `Community 1329`, `Community 947`, `Community 1340`, `Community 1341`, `Community 1090`, `Community 834`, `Community 840`, `Community 1229`, `Community 1256`, `Community 1389`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `dialogs` connect `Community 1243` to `Community 992`, `Community 960`, `Community 838`, `Community 167`, `Community 1194`, `Community 974`, `Community 847`, `Community 1200`, `Community 49`, `Community 981`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `supabase` connect `Community 819` to `Community 1145`, `Community 386`, `Community 131`, `Email Processing Ecosystem`, `Invoice Type Definitions`, `Community 391`, `Community 1146`, `Community 1161`, `Accounty Clientinvoicespage Clientinvoicespage`, `Community 1273`, `Accounty Generaterequestemail Addtoapprovalqueue`, `Accounty Generaterequestemail Generateemailparams`, `Accounty Generaterequestemail Generaterequestemail`, `Community 1424`, `Accounty Generaterequestemail Messagecategory`, `Community 1298`, `Community 1425`, `Accounty Generaterequestemail Updatemessagebody`, `Accounty Generaterequestemail Updatemessagestatus`, `Community 794`, `Community 925`, `Community 797`, `Components Feedbackfab Feedbackfab`, `Community 1315`, `Community 1188`, `Components Scopedlayout Scopedlayout`, `Contexts Companycontext Company`, `Community 1196`, `Community 941`, `Community 428`, `Community 1327`, `Community 181`, `Community 440`, `Community 828`, `Community 958`, `Community 447`, `Community 1087`, `Community 1218`, `Community 453`, `Community 1221`, `Community 455`, `Community 1358`, `Community 849`, `Community 861`, `Community 1117`, `Community 863`, `Community 889`, `Community 866`, `Community 1005`, `Community 880`, `Community 377`, `Community 890`, `Community 1019`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **What connects `skill_name`, `evals`, `__filename` to the rest of the system?**
  _14401 weakly-connected nodes found - possible documentation gaps or missing edges._
