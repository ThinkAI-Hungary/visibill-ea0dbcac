# Graph Report - eaisybill-prod  (2026-09-23)

## Corpus Check
- 2209 files · ~2,916,191 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 20888 nodes · 35601 edges · 1414 communities (1267 shown, 147 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 44 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `be57a7e4`
...
1. `cn()` - 591 edges
2. `Button` - 348 edges
3. `useToast()` - 327 edges
4. `supabase` - 278 edges
5. `useAuth()` - 263 edges
6. `useCompany()` - 232 edges
7. `accounts` - 202 edges
8. `accounts` - 202 edges
9. `Input` - 194 edges
...
## Communities (1414 total, 147 thin omitted)
...
Cohesion: 0.12
Nodes (21): getStatus(), generateExpectedReturns(), RETURN_TYPE_LABELS, STATUS_CONFIG, buildContrib2658Xml(), Contrib2658Data, escapeXml(), generateContrib2658Xml() (+13 more)
...
Cohesion: 0.06
Nodes (62): ClientMissingInvoicesReportPage(), COLORS, defaultBarData, defaultPieData, ClientPortalPage(), EmployeesPage(), DOCUMENT_TEMPLATES, ExitDocument (+54 more)

### Community 6 - "Invoice Type Definitions"
Cohesion: 0.23
Nodes (18): AnnualReportStep, AssetMovementSummary, EquityRowItem, FinancialMetrics, NotesSectionItem, NotesTemplateItem, SalaryMetrics, ValidationResult (+10 more)
...
Cohesion: 0.01
Nodes (336): AccountantManagementPage(), AssignCompanyDialog(), AvailableCompany, FirmAccountant, ROLE_COLORS, ROLE_LABELS, useAddCompanyAssignment(), useFirmAccountants() (+328 more)

### Community 11 - "Accounty Employeedetailspage Employeedetailspage"
Cohesion: 0.01
Nodes (202): acc_0, acc_1, acc_11, acc_111, acc_112, acc_113, acc_114, acc_115 (+194 more)

### Community 12 - "Accounty Generaterequestemail Addtoapprovalqueue"
Cohesion: 0.03
Nodes (89): AccountyApp(), EvPortfolioDashboard, PayrollPortfolioPage, TaoPortfolioPage, AccountyRole, useAccountyRole(), ProtectedAccountyRoute(), ProtectedAccountyRouteProps (+81 more)
...
Cohesion: 0.05
Nodes (34): AppLayout(), AppLayoutProps, ContentArea, TopBar, useIdleRoutePrefetch(), prefetchEaisybill(), AppSidebar, useIsMobile() (+26 more)
...
Cohesion: 0.02
Nodes (124): AccountantManagementPage, AccountingRedirectPage, AccountyOnboardingPage, AccountyScopedLayout, AdminTaxParametersPage, AiAnomalyReportPage, AiAssistantPage, AlertsCenterPage (+116 more)
...
Cohesion: 0.07
Nodes (48): EmployeeDetailsPage(), TABS, ChildItem, DECLARATION_TYPES, EditDeclarationDialog(), NewDeclarationDialog(), selectStyle, EmployeeDeclarationsTab() (+40 more)

### Community 22 - "Accounty Generaterequestemail Updatemessagebody"
Cohesion: 0.16
Nodes (27): InvoiceContext, InvoiceContextValue, InvoiceFilterContext, InvoiceFilterContextValue, InvoiceFilterProvider(), useInvoiceFilterContext(), InvoicePaginationProvider(), useInvoicePaginationContext() (+19 more)

### Community 23 - "Accounty Generaterequestemail Updatemessagestatus"
Cohesion: 0.08
Nodes (29): AssetDetailPanel(), AssetDetailPanelProps, parseLocalDate(), AssetListTable(), AssetListTableProps, DisposalDialogProps, InventoryCheckDialogProps, QrLabelDialogProps (+21 more)
...
Cohesion: 0.06
Nodes (68): CompanyStructurePage(), DataRetentionPage(), REQUEST_TYPE_LABELS, RepresentationPage(), CegkapuSettings, NavRepresentation, PortalStats, useAddNavRepresentation() (+60 more)
...
Cohesion: 0.10
Nodes (23): AccountingRedirectPage(), DataField(), EvMasterDataPage(), BookkeepingMode, CostRatio, EmploymentStatus, EvSetupWizardPage(), OrgType (+15 more)
...
Cohesion: 0.04
Nodes (92): BalanceSheetWidgets(), TransactionDetailsDialog(), Company, useOptionalCompany(), RecentInvoices(), GeneralLedgerComparisonTable(), GeneralLedgerComparisonTableProps, formatCurrency() (+84 more)
...
Cohesion: 0.11
Nodes (17): 10. 🔌 Külső Integrációk & API (2 db), 11. 🗓️ MNB & Jogi Frissítések (2 db), 12. 🚚 Szállítmányozás / HRTSPED (1 db), 13. 🏦 Open Banking & Aggreg8 Integráció (2 db), 1. 🏛️ NAV Integráció (8 db), 2. 📧 Email Küldés & Riportok (10 db), 3. 📥 Email Fogadás & Saját Levelező (5 db), 4. ⚡ Queue & Export Generálás (2 db) (+9 more)
...
Cohesion: 0.09
Nodes (22): active_filter_overdue_notice, batch_no_response, clear_filter, clear_search, mark_no_response_quick, new_ticket, priority_filter, placeholder (+14 more)
...
Cohesion: 0.08
Nodes (62): useAccountyClient(), useDateRange(), EvChamberPage(), ENGINE_LABELS, EvCompanyCarTaxPage(), DetailRow(), EvComparePage(), FORM_COLORS (+54 more)
...
Cohesion: 0.11
Nodes (18): toolbar, active_preset, add_account, ai_classification, builtin_badge, builtin_hr_preset, builtin_system_preset, export (+10 more)
...
Cohesion: 0.07
Nodes (30): items, analytics, annual_report, balance_sheet, categories, dashboard, exchange_rates, fixed_assets (+22 more)
...
Cohesion: 0.13
Nodes (14): `api_idempotency_keys`, `api_keys`, `app_error_logs`, `audit_logs`, `company_prompt_rules`, `daily_exchange_rates`, `dunning_sends`, `email_aliases` (+6 more)
...
Cohesion: 0.13
Nodes (7): InvoiceToPredict, corsHeaders, userRequestCounts, checkAutomationShield(), corsHeaders, logError(), corsHeaders
...
Cohesion: 0.03
Nodes (73): FUND_TYPES, Props, CATEGORIES, PRIORITIES, Props, STATUSES, Props, UNIT_TYPES (+65 more)
...
Cohesion: 0.33
Nodes (5): 🏛️ NAV Integráció, `nav_invoice_items`, `nav_invoices`, `nav_invoices` (Kimenő számlák kezelése), `nav_sync_logs`
...
Cohesion: 0.40
Nodes (4): 🎫 Hibajegy Rendszer, `ticket_comments`, `ticket_events`, `ticket_reads`
...
Cohesion: 0.13
Nodes (14): 1. Adatmodell (`acc_*` táblák), 2. Sorszám Generálás és Konkurencia Kezelés, 3. Integritás és Triggerek, 4. RPC Műveletek és Automatikus Kontírozás, 5. Frontend & Kliensoldali Architektúra (Decoupling), 6. Nyitóadatok és Főkönyvi Kivonat (GL) Integráció (2026-09-03 — Migráció `20260903120000`), 7. Körkörös Piszkozat-Védelem, Keményített Rekonciliáció és Realtime Szinkron (2026-09-03 — Migráció `20260903130000`), 8. Nyitó Varázsló Kliensoldali Állapotkezelés és Évnyitási Duplikáció-védelem (2026-09-04) (+6 more)
...
Cohesion: 0.13
Nodes (24): PdfDocumentAdapter, loadPdfLibraries(), loadSpreadsheetLibraries(), KeyValueSection, TableSection, TextSection, formatHungarianCurrency(), formatHungarianDate() (+16 more)
...
Cohesion: 0.11
Nodes (22): HtmlPreviewAdapter, SpreadsheetAdapter, DocumentEngine, CustomHtmlSection, DocumentDescriptor, DocumentMetadata, DocumentSection, DocumentType (+14 more)
...
Cohesion: 0.02
Nodes (183): KpiModalType, mockContextValue, mockHandlePrefetch, mockToggleSection, mockToggleSubSection, GlobalDatePicker(), GlobalDatePickerProps, InvoiceItemsDialogProps (+175 more)
...
Cohesion: 0.17
Nodes (11): 1. Hosted SyncUI és Zéró Felelősség (Zero Liability) Modell, 2. Kettős Edge Function Architektúra és Token Sanitization, 3. Adatbázis Séma és Nullability Migráció, 4. Aszinkron Háttér-feldolgozás (Python Worker & PGMQ), 5. Versenyhelyzet és UX Retesz (Race Condition Protection), 6. Felületi Elhelyezés és Kétirányú Navigáció (UI/UX Architecture), A-119: Aggreg8 PSD2 Open Banking AISP Integráció, Hosted SyncUI és Valós Idejű Tranzakció Szinkronizáció, Consequences (+3 more)
...
Cohesion: 0.04
Nodes (49): feedback, attachments_label, browse_link, cancel, close, company_label, delete_attachment, dialog_description (+41 more)
...
Cohesion: 0.22
Nodes (12): queryClient, TestComponent(), InvoiceProvider(), useInvoiceData(), useInvoiceFilters(), useInvoiceMutations(), useNettingDetection(), usePdfExport() (+4 more)
...
Cohesion: 0.07
Nodes (52): PayrollCalculation, CafeteriaAllocation, CafeteriaTaxResult, CafeteriaWarning, calculateCafeteriaTax(), calculatePocketTax(), DEFAULT_2026_SZEP_LIMITS, formatCafeteriaSummary() (+44 more)
...
Cohesion: 0.05
Nodes (37): manual_entry_dialog, amount_label, cancel_btn, date_label, delete_btn, desc_expense_partner, desc_income_partner, desc_invoice (+29 more)
...
Cohesion: 0.09
Nodes (24): DateRangeContext, DateRangeContextType, DateRangeProvider(), formatDate(), getInitialDates(), parseLocalDate(), CashbookCloseWizard(), CloseCheck (+16 more)
...
Cohesion: 0.05
Nodes (41): detail, add_attachment, attach_file_tooltip, attachments_title, cancel_resolution_request, comment_placeholder_active, comment_placeholder_locked, comments_count (+33 more)

### Community 808 - "Community 808"
Cohesion: 0.15
Nodes (19): XmlDocumentAdapter, downloadBlob(), DownloadOptions, downloadString(), AnykHeaderOptions, buildAnykEnvelope(), buildXmlTag(), escapeXml() (+11 more)
...
Cohesion: 0.07
Nodes (28): reclassify_btn, selected_count, general_ledger, balance_label, breadcrumb, bulk, closing_balance, date_label (+20 more)
...
Cohesion: 0.03
Nodes (195): BULK_STATUS_OPTIONS, ClientReportsPage(), ReportType, reportTypes, Filter, MODULE_OPTIONS, SOURCE_CONFIG, STATUS_CONFIG (+187 more)
...
Cohesion: 0.02
Nodes (198): Profile, SystemSettings, fetchManagementData(), postManagementData(), Aggreg8BankConnections(), Props, Skeleton(), SkeletonList() (+190 more)
...
Cohesion: 0.25
Nodes (7): 1. Négy Kötelező UI Állapot, 2. SyncUI Felugró Ablak (Popup) Kezelés, 3. Versenyhelyzet- és Villogásvédelem (Anti-Flicker & Race Condition Safeguard), 4. Beszédes Hibaüzenetek és Naplózás, Kapcsolódó, P-087: Aggreg8 Bankcsatlakozás, SyncUI Felugró Ablak és Élő Szinkronizáció UX, Rationale

### Community 852 - "Community 852"
Cohesion: 0.29
Nodes (3): A8_ENV, corsHeaders, URLS
...
Cohesion: 0.02
Nodes (135): AccountyErrorState(), AccountyErrorStateProps, ClientInvoicesPage(), CompanyPayrollSettingsPage(), DEFAULT_SETTINGS, PayrollSettings, Tab, TABS (+127 more)
...
Cohesion: 0.04
Nodes (103): DEFAULTS, FormData, KauType, TarhelyType, SAMPLE_ROWS, TEMPLATE_HEADERS, CourierInvoiceDialog(), CourierReportTab() (+95 more)
...
Cohesion: 0.08
Nodes (25): AccountantUser, Assignment, CompanyInfo, CONFIGURABLE_MODULES, ModulePermRow, PermissionMatrixPage(), ROLE_COLORS, ROLE_LABELS (+17 more)
...
Cohesion: 0.07
Nodes (26): Analytics, AnnualReportPage, BalanceSheet, ExchangeRates, FixedAssetsPage, GeneralLedgerPage, Index, Integrations (+18 more)
...
Cohesion: 0.12
Nodes (15): Ticket, useAddComment(), useIsSupportAdmin(), useTickets(), ManagementOverview(), ACTIVE_TICKET_STATUSES, matchTicketSearch(), sortTicketsByUnreadAndDate() (+7 more)
...
Cohesion: 0.36
Nodes (5): CalculateSkontoParams, detectShippingAmount(), formatTransferNarrative(), InvoiceLineItemCandidate, SkontoCalculationResult
...
Cohesion: 0.08
Nodes (41): VatA60TableProps, VatMLineDrillDown(), VatMLineDrillDownProps, VatXmlValidationDialogProps, calculateA60Aggregations(), calculateDeadlineCountdown(), calculateVatBalances(), findSuspiciousReverseChargeInvoices() (+33 more)
...
Cohesion: 0.11
Nodes (20): AuditLogPage(), EVENT_COLORS, EVENT_LABELS, EVENT_TYPES, ExportButtonProps, Deadline, NavDeadlinesPage(), STATUS_OPTIONS (+12 more)
...
Cohesion: 0.15
Nodes (17): InvoiceImagePreview(), InvoiceImagePreviewProps, signedUrlCache, SuggestedInvoiceLinkDialog(), decodeHtmlEntities(), getAvatarColor(), getInitials(), getInitials() (+9 more)
...
Cohesion: 0.08
Nodes (31): table, closing_dialog, all_registers, close, description, empty, items_count, pdf (+23 more)
...
Cohesion: 0.10
Nodes (19): AccountyClient, CASHBOOK_CATEGORIES, CashbookEntryForm(), CashbookEntryFormData, CashbookEntryFormProps, CategoryNode, EntryDirection, FLAT_CATEGORIES (+11 more)

### Community 1020 - "Community 1020"
Cohesion: 0.29
Nodes (7): summary, currency, expense, income, items, net, title
...
Cohesion: 0.10
Nodes (20): closing_dialog, all_registers, close, description, empty, items_count, pdf, print_pdf (+12 more)
...
Cohesion: 0.18
Nodes (11): table, col_assignee, col_created_at, col_priority, col_status, col_subject, col_system, col_ticket_number (+3 more)

### Community 1087 - "Community 1087"
Cohesion: 0.11
Nodes (22): TicketComment, TicketPriority, TicketStatus, TicketType, useDeleteTicket(), useIsManagementRole(), useRequestTicketResolution(), useRespondTicketResolution() (+14 more)
...
Cohesion: 0.05
Nodes (29): ACCOUNTY_ADMIN_ONLY, ACCOUNTY_ALWAYS_ACCESSIBLE, ACCOUNTY_SENIOR_MODULES, AccountyModule, AccountyRole, ADMIN_ONLY_MODULES, ALL_MODULES, ASSISTANT_MODULES (+21 more)
...
Cohesion: 0.08
Nodes (25): toasts, toasts, attachment_added, attachment_added_desc, attachment_removed, batch_response_cleared_desc, batch_response_cleared_title, error_send (+17 more)
...
Cohesion: 0.22
Nodes (9): AccountyShellContextType, createDefaultAccountyShellContext(), AccountyBreadcrumbsOptions, BreadcrumbItem, getAccountyBreadcrumbs(), normalizeBreadcrumbItem(), STATIC_PORTFOLIO_ROUTES, useAccountyBreadcrumbs() (+1 more)
...
Cohesion: 0.29
Nodes (7): SuperadminModuleData, SuperadminModuleKey, DatePickerInput(), COL_LABELS, MODULE_COLUMNS, STATUS_KEYS, SUPERADMIN_MODULES

### Community 1154 - "Community 1154"
Cohesion: 0.10
Nodes (27): TabType, ViewMode, addToApprovalQueue(), categoryLabels, fireApprovalNotification(), GeneratedEmail, GenerateEmailParams, generateRequestEmail() (+19 more)
...
Cohesion: 0.07
Nodes (32): FALLBACK_CATEGORY_MAP, FALLBACK_KNOWLEDGE_ARTICLES, FALLBACK_KNOWLEDGE_CATEGORIES, useDebounce(), useKnowledgeArticle(), useKnowledgeArticles(), useKnowledgeCategories(), KnowledgeArticleCard (+24 more)
...
Cohesion: 0.22
Nodes (9): file_preview, close, csv_error, download, excel_title, first_100_rows, open_new_tab, pdf_title (+1 more)
...
Cohesion: 0.06
Nodes (31): CYCLE_STEPS, EMPLOYMENT_TYPE_LABELS, MONTHS, PayrollCyclePage(), CONFIGS, DeclType, GenericDeclarationPage(), EmployeeCafeteriaTab() (+23 more)
...
Cohesion: 0.28
Nodes (8): ActivityLogPdfDialogProps, AuditLogRow, groupEmailTimelineItems(), isMailgunUpload(), normalize(), TimelineItem, ActivityLogTimelineItemProps, positionNumbersMatch()
...
Cohesion: 0.29
Nodes (7): tooltips, edit_gl, final_balance, refresh, temp_balance, view_classic, view_summary
...
Cohesion: 0.09
Nodes (18): CompanyDetail, FilesData, OverviewData, UserDetail, CompanyDetailView(), CompanyDetailViewProps, ControlCenter, ManagementDashboard() (+10 more)
...
Cohesion: 0.05
Nodes (54): AccountyLayout(), AccountyLayoutInner(), AccountyRoleProvider(), accountyPrefetchMap, AccountyShellProvider(), extractCompanyIdFromPath(), SHELL_CONTEXT_KEY, SubGroup (+46 more)
...
Cohesion: 0.12
Nodes (20): InvoicePaginationContext, InvoicePaginationContextValue, InvoiceApprovalDialogProps, SuggestedInvoiceLinkDialogProps, NettingCardSectionProps, NavInvoice, SubmittedInvoice, UseInvoiceMutationsParams (+12 more)
...
Cohesion: 0.36
Nodes (7): InvoiceImageDialog(), decodeSenderEmail(), getDisplayName(), isLikelyPdf(), ACTION_CONFIG, ActivityLogTimelineItem(), ENTITY_CONFIG
...
Cohesion: 0.09
Nodes (27): useCompanyInvoices(), CashbookLedgerView(), COLUMN_LABELS, LedgerEntry, MonthlyAggregate, ViewMode, CashbookMainPage(), CATEGORY_LABELS (+19 more)
...
Cohesion: 0.31
Nodes (8): useAccountyTaxProfile(), useTaoYearly(), ClientTaoMainPage(), formatTaoAmount(), TaoTab, WIZARD_STEPS, WIZARD_STEPS_HR, TaoYearEndWizardPage()
...
Cohesion: 0.13
Nodes (21): ReportsPage(), ReportType, reportTypes, FullReportData, InvoiceReportRow, ReportRow, ReportCatalog(), ReportCatalogProps (+13 more)
...
Cohesion: 0.17
Nodes (19): InvoiceBulkActionsBar(), useInvoiceContext(), InvoiceDialogManager(), InvoiceFilterBar(), InvoiceTabSelector(), InvoiceHeader(), InvoiceKpiCards(), TransactionRecord (+11 more)
...
## Knowledge Gaps
- **14309 isolated node(s):** `skill_name`, `evals`, `__filename`, `__dirname`, `rootDir` (+14304 more)
...
- **Why does `general_ledger` connect `Community 821` to `Community 1285`, `Community 659`, `Accounty Mockdata Blockingcategory`, `Community 1305`, `Community 669`, `Community 1055`, `Community 1190`, `Community 1192`, `Community 1068`, `Community 813`, `Community 942`, `Community 1329`, `Community 947`, `Community 1340`, `Community 1341`, `Community 1342`, `Community 1090`, `Community 834`, `Community 1349`, `Community 840`, `Community 1229`, `Community 1256`, `Community 1388`, `Community 1389`, `Community 1391`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `accounts` connect `Accounty Mockdata Blockingcategory` to `Community 821`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `general_ledger` connect `Community 817` to `Community 1281`, `Community 899`, `Community 1159`, `Accounty Employeedetailspage Employeedetailspage`, `Community 791`, `Community 1176`, `Community 1178`, `Community 940`, `Community 1071`, `Community 715`, `Community 599`, `Community 1239`, `Community 601`, `Community 1249`, `Community 1251`, `Community 1258`, `Community 1386`, `Community 1388`, `Community 1392`, `Community 1393`, `Community 1394`, `Community 1265`, `Community 242`, `Community 1016`, `Community 1275`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **What connects `skill_name`, `evals`, `__filename` to the rest of the system?**
  _14316 weakly-connected nodes found - possible documentation gaps or missing edges._
