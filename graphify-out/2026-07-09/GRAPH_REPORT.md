# Graph Report - eaisybill-prod  (2026-07-09)

## Corpus Check
- 1139 files · ~1,792,166 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6287 nodes · 14539 edges · 450 communities (334 shown, 116 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 45 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5404e25d`
...
## Communities (450 total, 116 thin omitted)
...
Cohesion: 0.07
Nodes (36): ExportButton(), ExportButtonProps, useTransfers(), downloadFile(), downloadMt940(), downloadSepaXml(), escapeXml(), CHANGE_CODES (+28 more)
...
Cohesion: 0.14
Nodes (14): CompanySwitcher(), GlobalDatePicker(), PATH_TO_MODULE, useOnlineStatus(), AccountyCommandPaletteProps, AccountyHeaderProps, AccountySidebar(), AccountySidebarProps (+6 more)
...
Cohesion: 0.10
Nodes (24): ClientMissingInvoicesPage(), useGeneratePortalToken(), useAccountyMissingCounts(), useAddMissingItem(), useResolveMissingItem(), AddMissingInvoiceModal(), getPriorityBadge(), getStatusBadge() (+16 more)
...
Cohesion: 0.06
Nodes (48): isUploadNotified(), LiveNotificationProvider(), _notifiedUploadIds, _pendingSessionUploads, registerPendingUpload(), UploadedFilesModal(), activeStatuses, CMREscalationDialog (+40 more)
...
Cohesion: 0.06
Nodes (34): AuthContext, AuthContextType, AuthProvider(), VatRegime, DashboardMetrics, DashboardMetricsProps, PettyCashCurrencyBalance, ProfileSummaryProps (+26 more)

### Community 17 - "Accounty Generaterequestemail Messagecategory"
Cohesion: 0.08
Nodes (31): ACTION_META, ClientDetailsPage(), DEFAULT_META, RecentActivities(), ClientInvoicesPage(), MissingItemForEmail, BlockingCategory, blockingCategoryMeta (+23 more)
...
Cohesion: 0.06
Nodes (59): AccountyWelcomeWizard(), AdminTaxParametersPage(), PARAM_LABELS, AuditLogPage(), EVENT_COLORS, EVENT_LABELS, EVENT_TYPES, GdprPage() (+51 more)
...
Cohesion: 0.08
Nodes (45): EvChamberPage(), DetailRow(), EvComparePage(), FORM_COLORS, FORM_ICONS, QUARTER_LABELS, STATUS_CFG, EvContributionsPage() (+37 more)
...
Cohesion: 0.05
Nodes (82): AuthGuard(), AuthGuardProps, Category, EditableLineItem, InvoiceFullEditDialogProps, InvoiceLineItem, Project, SubmittedInvoice (+74 more)
...
Cohesion: 0.11
Nodes (23): AccountyLayout(), AccountyLayoutInner(), PrivacyConsent, PrivacyPolicyPage(), sections, useAccountyKpis(), useMyAssignedCompanyIds(), useAccountyMonthlyTrend() (+15 more)

### Community 30 - "Accounty Types Blockingitem"
Cohesion: 0.09
Nodes (39): AnimatedNumber(), KpiModalType, fmtHuf(), SUB_ACCOUNT_CONFIG, SzepCardTab(), formatCurrency(), JournalEntry, JournalView() (+31 more)
...
Cohesion: 0.04
Nodes (106): STATUS_CONFIG, TYPE_LABELS, Filter, MODULE_OPTIONS, SOURCE_CONFIG, STATUS_CONFIG, NewClientPage(), SettingsTab (+98 more)
...
Cohesion: 0.11
Nodes (26): CompanySelector(), CourierReportTab(), useDateRange(), useCourierReportData(), useSalaryData(), formatDate(), formatPaymentDate(), getStatusBadge() (+18 more)
...
Cohesion: 0.19
Nodes (17): ProtectedRoute(), ProtectedRouteProps, mockedExtractPageSegment, mockedUseEaisybillPermissions, mockedUseUserRole, queryClient, ScopedLayout(), useDbModulePermissions() (+9 more)
...
Cohesion: 0.23
Nodes (11): DateRangeContext, DateRangeContextType, DateRangeProvider(), formatDate(), getInitialDates(), decodeHtmlEntities(), getInitials(), displayTaxNumber() (+3 more)
...
Cohesion: 0.04
Nodes (85): Props, State, NylasEmailConnectProps, NylasToken, AvailableInvoice, MatchedCourierReport, MatchedInvoice, MatchedNavInvoice (+77 more)
...
Cohesion: 0.05
Nodes (67): formatValue(), formatCurrency(), GeneralLedgerTable, GeneralLedgerTableBase(), GeneralLedgerTableProps, GeneralLedgerTableRef, LedgerItem, ManagePresetsModal() (+59 more)
...
Cohesion: 0.03
Nodes (82): FeatureCard(), Deadline, NavDeadlinesPage(), STATUS_OPTIONS, TYPE_CONFIG, ALL_EMPLOYMENT_TYPES, JOB_TYPES, JobType (+74 more)
...
Cohesion: 0.18
Nodes (18): useAccountyRole(), ClientDeadline, DeadlineGroup, deadlineTypeTitle, KpiCard(), Status, TaxCalendarPage(), useAccountyDeadlines() (+10 more)
...
Cohesion: 0.06
Nodes (39): EmployeeImportPage(), ImportRow, SAMPLE_ROWS, TEMPLATE_HEADERS, EmployeesPage(), AccountantUser, Assignment, CompanyInfo (+31 more)
...
Cohesion: 0.14
Nodes (17): ExpandedInvoiceRowProps, Category, CourierReportRecord, NavInvoice, Partner, Project, SubmittedInvoice, TransactionRecord (+9 more)
...
Cohesion: 0.07
Nodes (63): ClientMissingInvoicesReportPage(), COLORS, defaultBarData, defaultPieData, ChatMessage, ClientPortalPage(), generateToken(), MONTHS (+55 more)
...
Cohesion: 0.07
Nodes (37): AssetActivationDialog(), AssetDetailPanel(), AssetDetailPanelProps, DisposalDialog, EVENT_ICONS, EVENT_LABELS, QrLabelDialog, ReactivationDialog (+29 more)
...
Cohesion: 0.06
Nodes (35): A-019: Management Dashboard Architektúra, Adatforrások, API Design: Action-based Query Params, Architektúra, Architektúra: Edge Function + Service Role, Consequences, Context, Cross-Project Monitoring (+27 more)
...
Cohesion: 0.08
Nodes (37): AccountyApp(), ClientReportsPage(), ReportType, reportTypes, ReportsPage(), ReportType, reportTypes, useAccountyPortalStats() (+29 more)
...
Cohesion: 0.06
Nodes (64): EmployeeDetailsPage(), TABS, EmployeeWizardPage(), EMPLOYMENT_TYPES, FormData, FormField(), INITIAL_FORM, STEPS (+56 more)
...
Cohesion: 0.08
Nodes (37): useAccountyClient(), ENGINE_LABELS, EvCompanyCarTaxPage(), EvContribReturnPage(), EvHipaReturnPage(), STATUS_CFG, EvMasterDataPage(), BookkeepingMode (+29 more)
...
Cohesion: 0.05
Nodes (54): AccountyWelcomeWizardProps, EmailAlias, formatDate(), formatDateTime(), FullInvoice, InvoiceDetailPopup(), InvoiceDetailPopupProps, statusLabels (+46 more)
...
Cohesion: 0.06
Nodes (68): FirmMembersCard(), Profile, ProfileSettingsPage(), SystemSettings, CategoryCard(), ChangePasswordDialog(), CourierReportTabProps, MatchDetails (+60 more)
...
## Knowledge Gaps
- **3178 isolated node(s):** `entrypoint_path`, `name`, `files`, `verify_jwt`, `{ createClient }` (+3173 more)
...
- **Why does `cn()` connect `Hooks Useaccountydata Useresolvemissingitem` to `Community 386`, `Hooks Useidletimeout Useidletimeout`, `Email Processing Ecosystem`, `Invoice Type Definitions`, `Accounty Accountyrolecontext Useaccountyrole`, `Accounty Generaterequestemail Addtoapprovalqueue`, `Accounty Generaterequestemail Generatedemail`, `Accounty Generaterequestemail Generaterequestemail`, `Accounty Generaterequestemail Getapprovalqueue`, `Accounty Generaterequestemail Messagecategory`, `Accounty Generaterequestemail Messagestatus`, `Accounty Generaterequestemail Missingitemforemail`, `Hooks Useleaverequests Leavestatus`, `Accounty Generaterequestemail Updatemessagebody`, `Community 407`, `Accounty Mockdata Blockingcategory`, `Hooks Usepayrolldata Batchpayrollresult`, `Accounty Mockdata Blockingitem`, `Accounty Types Blockingcategory`, `Accounty Types Blockingitem`, `Community 415`, `Components Emailpreferences Emailpreferences`, `Components Feedbackfab Feedbackfab`, `Components Producttour Producttour`, `Components Scopedlayout Scopedlayout`, `Community 421`, `Contexts Companycontext Company`, `Community 423`, `Community 420`, `Community 170`, `Contexts Themecontext Usetheme`, `Community 171`, `Dashboard Useractivitydialog Useractivitydialog`, `Community 175`, `Eaisybill Prod Readme`, `Community 177`, `Fixed Assets Depreciationcards Depreciationcards`, `General Ledger Uploadchartofaccountsmodal Uploadch`, `Community 441`, `Hooks Useaccountydata Accountykpis`, `Community 443`, `Community 444`, `Hooks Useaccountydata Colleaguestat`, `Hooks Useaccountydata Companyinvoice`, `Community 323`, `Hooks Useaccountydata Monthlytrendpoint`, `Community 327`, `Hooks Useaccountydata Useaccountyauditlog`, `Community 457`, `Community 332`, `Hooks Useaccountydata Useaccountyportalstats`, `Community 339`, `Hooks Useaccountydata Useaccountyreportdata`, `Community 343`, `Community 216`, `Hooks Useaccountydata Useupdatekanbanstatus`, `Hooks Useaccountydata Useupsertcommunicationprefs`, `Hooks Useaccountydata Useupserttaxprofile`, `Community 351`, `Hooks Useappready Redirecttarget`, `Community 358`, `Community 364`, `Hooks Usedashboarddata Monthlydata`, `Community 242`, `Community 373`, `Community 374`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `VisiBill - Project Documentation` connect `Accounty Sharedcomponents Animatednumber` to `Hooks Useaccountydata Invoicereportrow`, `Community 417`, `Community 391`, `Community 424`, `Community 455`, `Dashboard Dashboardskeleton Metriccardskeleton`, `Fixed Assets Inventorycheckdialog Inventorycheckdi`, `Hooks Useaccountydata Useaccountytaxprofile`, `Hooks Useaccountydata Accountycommunicationprefs`?**
