  ...
  return createPortal(
    <TooltipProvider delayDuration={200}>
      ...
      >
        ...
        {/* Thumbnails strip */}
        {hasMultiple && (
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-10 flex items-center gap-2 bg-black/50 rounded-full px-3 py-2 backdrop-blur-md border border-white/10">
            {images.map((url, i) => (
              <button
                key={i}
                onClick={(e) => {
