...
const IosToggle = React.forwardRef<HTMLButtonElement, IosToggleProps>(({
  ...
  disabled && "cursor-not-allowed opacity-50", className)} {...props}>
        ...
        {checked ? <span className="absolute left-[4px] top-1/2 -translate-y-1/2 text-[8px] font-bold uppercase tracking-tight text-success-foreground pl-[4px]">
            {onLabel}
          </span> : <span className="absolute right-[4px] top-1/2 -translate-y-1/2 text-[8px] font-bold uppercase tracking-tight text-warning-foreground pr-[4px]">
            {offLabel}
          </span>}
