...
const Table = React.forwardRef<HTMLTableElement, TableProps>(
  ({ className, containerClassName, hideScrollbar, ...props }, ref) => (
    <div className={cn("relative w-full overflow-x-auto", hideScrollbar && "scrollbar-none [&::-webkit-scrollbar]:hidden [scrollbar-width:none]", containerClassName)}>
