...
export const CHANNEL_CONFIGS: Record<UploadChannelId, ChannelConfig> = {
  ...
  bank: {
    id: 'bank',
    title: 'Bankkivonatok',
    cardTitle: 'Bankkivonat fájlok feltöltése',
    ...
    dragPrompt: 'Húzd ide a bankkivonat fájlokat, vagy kattints a tallózáshoz',
    actionButtonLabel: (count: number) => `${count} bankkivonat fájl feltöltése`,
  ...
  transactions: {
    ...
    cardDescription: 'Válassz CSV vagy Excel fájlokat, amelyek banki vagy egyéb pénzügyi tranzakciókat tartalmaznak. A rendszer automatikusan kinyeri az adatokat és rögzíti a tranzakciókat.',
    icon: CreditCard,
    ...
    fileTypeDescription: 'CSV vagy Excel (XLS, XLSX) fájlokat',
