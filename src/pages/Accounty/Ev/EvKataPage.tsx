  ...
  return (
    <div className="w-full space-y-6 page-animate">
      ...
      <div className="flex items-center gap-2 text-sm text-muted-foreground">
        ...
        <span className="text-foreground font-medium">KATA kisadózó</span>
      </div>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground">KATA kisadózó</h1>
            <p className="text-sm text-muted-foreground">KATA tv. 7–8. § — {client?.name || 'Ügyfél'}</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="bg-card rounded-lg border border-border shadow-soft p-5 space-y-4">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-medium text-muted-foreground">Aktív hónapok</label>
            ...
            <div className="pt-2 border-t border-border/50 space-y-2">
              <div className="flex justify-between text-xs">
                <span className="text-muted-foreground">Bevételi keret</span>
            ...
            <div className="pt-2 border-t border-border/50 space-y-1.5">
              <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider">KATA paraméterek</p>
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <div className="bg-card rounded-lg border border-border p-4 shadow-soft">
              <p className="text-xs text-muted-foreground mb-1">Éves tételes adó</p>
              <p className="text-lg font-bold text-amber-600">{formatHuf(result.annualFee)}</p>
              <p className="text-[10px] text-muted-foreground">{result.activeMonths} hónap</p>
            </div>
            <div className="bg-card rounded-lg border border-border p-4 shadow-soft">
              <p className="text-xs text-muted-foreground mb-1">Különadó</p>
              <p className={cn('text-lg font-bold', result.surchargeAmount > 0 ? 'text-red-600' : 'text-muted-foreground')}>
            ...
            <div className="bg-card rounded-lg border border-border p-4 shadow-soft">
              ...
              <p className="text-lg font-bold text-foreground">{formatHuf(result.totalTax)}</p>
              <p className="text-[10px] text-muted-foreground">Eff: {formatPercent(result.effectiveRate)}</p>
            </div>
          </div>
          ...
          <div className="bg-card rounded-lg border border-border shadow-soft overflow-hidden">
            <div className="px-5 py-3 border-b border-border">
              <h3 className="text-sm font-bold text-foreground">Havi bontás</h3>
            </div>
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      active ? 'bg-amber-50/50 dark:bg-amber-900/10' : 'bg-muted/50'
                    )}
                  >
                    <p className="text-[10px] text-muted-foreground">{['Jan', 'Feb', 'Már', 'Ápr', 'Máj', 'Jún', 'Júl', 'Aug', 'Sze', 'Okt', 'Nov', 'Dec'][i]}</p>
                    <p className={cn(
                      'text-xs font-bold mt-0.5',
                      active ? 'text-amber-600' : 'text-muted-foreground/60'
                    )}>
