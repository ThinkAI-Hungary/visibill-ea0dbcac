  ...
  return (
    <div className="w-full space-y-6 page-animate">
      ...
      <div className="flex items-center gap-2 text-sm text-muted-foreground">
        ...
        <ChevronRight className="w-3 h-3" />
        <span className="text-foreground font-medium">VSZJA – Osztalékalap</span>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-foreground">Vállalkozói osztalékalap</h1>
          <p className="text-sm text-muted-foreground">Szja tv. 49/C.§ – vállalkozói kivét és osztalékalap számítás</p>
        </div>
      </div>
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="bg-card rounded-lg border border-border shadow-soft p-5 space-y-4">
            ...
            <div className="space-y-3">
              <div>
                <label className="text-xs font-medium text-muted-foreground block mb-1">Vállalkozói jövedelem (Ft)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="text-xs font-medium text-muted-foreground block mb-1">Megfizetett vállalkozói SZJA (Ft)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="text-xs font-medium text-muted-foreground block mb-1">Megfizetett szocho (Ft)</label>
                <input
                  type="number"
                  value={sochoPaid}
              ...
              <div>
                <label className="text-xs font-medium text-muted-foreground block mb-1">Vállalkozói kivét (éves) (Ft)</label>
                <input
                  type="number"
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <div className="bg-card rounded-lg border border-border p-4 shadow-soft">
              <p className="text-xs text-muted-foreground mb-1">Osztalékalap</p>
              <p className="text-lg font-bold text-violet-600 tabular-nums">{formatHuf(dividendBase)}</p>
            </div>
            <div className="bg-card rounded-lg border border-border p-4 shadow-soft">
              <p className="text-xs text-muted-foreground mb-1">Osztalék adó</p>
              <p className="text-lg font-bold text-red-500 tabular-nums">{formatHuf(totalDividendTax)}</p>
            </div>
            <div className="bg-card rounded-lg border border-border p-4 shadow-soft">
              <p className="text-xs text-muted-foreground mb-1">Nettó osztalék</p>
              <p className="text-lg font-bold text-green-600 tabular-nums">{formatHuf(netDividend)}</p>
            </div>
            <div className="bg-card rounded-lg border border-border p-4 shadow-soft">
              <p className="text-xs text-muted-foreground mb-1">Teljes adóráta</p>
              <p className="text-lg font-bold text-primary tabular-nums">{effectiveRate.toFixed(1)}%</p>
            </div>
          </div>
          ...
          <div className="bg-card rounded-lg border border-border shadow-soft overflow-hidden">
            <div className="px-5 py-3 border-b border-border/50">
              <h2 className="text-sm font-bold text-foreground">Osztalékalap részletezése</h2>
            </div>
          ...
          <div className="bg-card rounded-lg border border-border shadow-soft overflow-hidden">
            <div className="px-5 py-3 border-b border-border/50 bg-muted/40/50 dark:bg-muted/20">
              <h2 className="text-sm font-bold text-foreground flex items-center gap-2">
