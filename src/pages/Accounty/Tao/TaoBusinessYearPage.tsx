  ...
  return (
    <div className="w-full space-y-6 page-animate max-w-3xl">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-foreground">Üzleti Év Beállítások</h1>
          <p className="text-sm text-muted-foreground">Fordulónap és bevallási határidők (spec 2.5)</p>
        </div>
      </div>

      <div className="bg-card rounded-lg border border-border p-6 shadow-soft space-y-5">
        <h2 className="text-base font-bold text-foreground">Üzleti év típusa</h2>
        ...
        {yearType === 'custom' && (
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="text-xs font-medium text-muted-foreground mb-1 block">Fordulónap — hónap</label>
            ...
            <div>
              <label className="text-xs font-medium text-muted-foreground mb-1 block">Fordulónap — nap</label>
      ...
      {/* Derived values */}
      <div className="bg-card rounded-lg border border-border p-6 shadow-soft space-y-3">
        <h2 className="text-base font-bold text-foreground">Származtatott határidők</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-3 bg-muted/50 rounded-lg">
            <p className="text-xs text-muted-foreground">Bevallási határidő</p>
            <p className="text-sm font-bold text-foreground mt-1">{filingDeadline}</p>
          </div>
          <div className="p-3 bg-muted/50 rounded-lg">
            <p className="text-xs text-muted-foreground">Bevallás formakód</p>
            <p className="text-sm font-bold font-mono text-foreground mt-1">{formCode}</p>
          </div>
          <div className="p-3 bg-muted/50 rounded-lg">
            <p className="text-xs text-muted-foreground">Beszámoló közzététel</p>
            <p className="text-sm font-bold text-foreground mt-1">Fordulónap + 5 hó</p>
          </div>
        </div>
