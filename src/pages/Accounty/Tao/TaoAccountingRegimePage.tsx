  ...
  return (
    <div className="w-full space-y-6 page-animate max-w-3xl">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-foreground">Beszámolási Rezsim</h1>
          <p className="text-sm text-muted-foreground">Szt. vs. IFRS (spec 2.6)</p>
        </div>
      </div>

      <div className="bg-card rounded-lg border border-border p-6 shadow-soft space-y-5">
        <h2 className="text-base font-bold text-foreground">Rezsim választó</h2>
        <div className="flex gap-4">
          {([
            ...
            <label key={opt.value} className={cn(
              'flex-1 p-5 rounded-lg border-2 cursor-pointer transition-all',
      ...
      {regime === 'ifrs' && (
        <div className="bg-card rounded-lg border border-border p-6 shadow-soft space-y-4">
          <h2 className="text-base font-bold text-foreground">IFRS-specifikus tételek</h2>
