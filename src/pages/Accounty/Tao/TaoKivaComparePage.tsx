  ...
  return (
    <div className="w-full space-y-6 page-animate max-w-5xl">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-foreground">TAO vs KIVA Összehasonlítás</h1>
          <p className="text-sm text-muted-foreground">{client?.name || 'Ügyfél'} — Melyik adónem az előnyösebb?</p>
        </div>
      </div>

      {/* Info */}
      <div className="flex items-start gap-2 p-4 bg-violet-50 dark:bg-violet-900/20 rounded-lg border border-violet-200 dark:border-violet-800">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {/* TAO */}
        <div className={cn(
          'rounded-lg border-2 p-6 shadow-soft transition-all',
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              <h3 className="text-lg font-bold text-foreground">TAO</h3>
              <p className="text-xs text-muted-foreground">Társasági adó — 9%</p>
            </div>
            {computed.winner === 'tao' && (
          ...
          <div className="space-y-2 bg-muted/50 rounded-lg p-4">
            {[
              ...
              <div key={i} className="flex justify-between text-xs">
                ...
                <span className="font-mono font-bold text-foreground/90">{fmt(r.value)} Ft</span>
              </div>
            ))}
            <div className="border-t border-border pt-2 mt-2">
              <div className="flex justify-between">
                <span className="text-sm font-bold text-foreground">Összterhelés</span>
        ...
        <div className={cn(
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              <h3 className="text-lg font-bold text-foreground">KIVA</h3>
              <p className="text-xs text-muted-foreground">Kisvállalati adó — 10%</p>
            </div>
      ...
      <div className={cn(
        ...
        {computed.winner === 'tie' || (computed.taoTotal === 0 && computed.kivaTotal === 0) ? (
          <p className="text-sm text-muted-foreground">Töltse ki az adatokat az összehasonlításhoz</p>
        ) : (
          <>
