  ...
  return (
    <div className="page-animate">
      <div className="text-center mb-8">
        <h1 className="text-2xl font-bold text-foreground">Könyvelőprogram integráció</h1>
        <p className="text-muted-foreground mt-1">Automatizáld az adatátvitelt a könyvelőprogramod és a Visibill között</p>
      </div>

      <div className="bg-card rounded-lg p-6 border border-border shadow-soft mb-6">
        <h2 className="text-lg font-semibold text-foreground mb-4">Milyen könyvelőprogramot használsz?</h2>
        
        <div className="grid grid-cols-3 gap-4">
          {/* RLB Option */}
          <button 
            onClick={() => setIntegrationType('rlb')}
            className={cn("p-4 rounded-lg border-2 text-left transition-all", integrationType === 'rlb' ? "border-primary bg-accent/40 text-foreground" : "border-border hover:border-primary/20")}
          >
            <div className="w-10 h-10 mb-3 bg-card border border-border rounded flex items-center justify-center shadow-soft">
              <BarChart2 className="w-6 h-6 text-primary" />
            </div>
            <h3 className="font-semibold text-foreground">RLB</h3>
            <p className="text-xs text-muted-foreground mt-1 leading-tight">RLB könyvelőprogram integráció RPA-val</p>
          ...
          <button 
            ...
            className={cn("p-4 rounded-lg border-2 text-left transition-all", integrationType === 'novitax' ? "border-primary bg-accent/40 text-foreground" : "border-border hover:border-primary/20")}
          >
            <div className="w-10 h-10 mb-3 bg-card border border-border rounded flex items-center justify-center shadow-soft">
            ...
            <h3 className="font-semibold text-foreground">Novitax</h3>
            <p className="text-xs text-muted-foreground mt-1 leading-tight">Novitax könyvelőprogram integráció</p>
          ...
          <button 
            ...
            className={cn("p-4 rounded-lg border-2 text-left transition-all", integrationType === 'other' ? "border-primary bg-accent/40 text-foreground" : "border-border hover:border-primary/20")}
          >
            <div className="w-10 h-10 mb-3 bg-card border border-border rounded flex items-center justify-center shadow-soft">
            ...
            <h3 className="font-semibold text-foreground">Egyéb / Nincs</h3>
            <p className="text-xs text-muted-foreground mt-1 leading-tight">Manuális exportálás CSV/Excel formátumban</p>
      ...
      {integrationType === 'rlb' && (
        <div className="bg-card rounded-lg p-6 border border-border shadow-soft page-animate slide-in-from-top-4 duration-300">
          <h2 className="text-xl font-semibold text-foreground">RLB integráció beállítása</h2>
          <p className="text-sm text-muted-foreground mt-1 mb-6">Kövesd az alábbi lépéseket az integráció beállításához</p>
          ...
          <div className="space-y-4 mb-8">
            {[
              ...
              <div key={i} className="flex items-center gap-3">
                <div className="w-6 h-6 rounded-full bg-muted text-muted-foreground flex items-center justify-center text-xs font-semibold">{i + 1}</div>
          ...
          <div className="flex gap-3">
            <Button variant="outline" className="gap-2 text-muted-foreground" onClick={() => {
      ...
      {integrationType === 'novitax' && (
        <div className="bg-card rounded-lg p-6 border border-border shadow-soft page-animate slide-in-from-top-4 duration-300">
          <h2 className="text-xl font-semibold text-foreground">Novitax integráció</h2>
          <p className="text-sm text-muted-foreground mt-1 mb-6">A Novitax integráció hamarosan elérhető. Értesítünk, amint kész!</p>
      ...
      {integrationType === 'other' && (
        <div className="bg-card rounded-lg p-6 border border-border shadow-soft page-animate slide-in-from-top-4 duration-300">
          <h2 className="text-xl font-semibold text-foreground">Manuális exportálás</h2>
          <p className="text-sm text-muted-foreground mt-1 mb-6">Az adatokat CSV vagy Excel formátumban exportálhatod bármikor a portfólió nézetből</p>
