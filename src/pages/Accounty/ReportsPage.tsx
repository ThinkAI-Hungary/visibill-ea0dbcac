...
const reportTypes = [
  { id: 'havi', title: 'Havi összesítő', description: 'Bejövő és kimenő számlák összeszítése, ÁFA kimutatás', icon: Calendar, color: 'text-indigo-500', bg: 'bg-indigo-50 dark:bg-indigo-900/30' },
...
const recentReports = [
  { id: 1, title: 'Tech Solutions - Havi összesítő 2024 Január', date: '2024. 01. 15.', client: 'Tech Solutions Kft.', format: 'PDF', iconColor: 'text-red-500', bg: 'bg-red-50 dark:bg-red-900/30' },
  { id: 2, title: 'Digital Partners - ÁFA kimutatás Q4 2023', date: '2024. 01. 10.', client: 'Digital Partners Zrt.', format: 'EXCEL', iconColor: 'text-emerald-500', bg: 'bg-emerald-50 dark:bg-emerald-900/30' },
  { id: 3, title: 'Innovation Labs - Költségkimutatás 2023', date: '2024. 01. 05.', client: 'Innovation Labs Kft.', format: 'PDF', iconColor: 'text-red-500', bg: 'bg-red-50 dark:bg-red-900/30' },
  { id: 4, title: 'Smart Office - Havi összesítő 2024 Január', date: '2024. 01. 14.', client: 'Smart Office Bt.', format: 'PDF', iconColor: 'text-red-500', bg: 'bg-red-50 dark:bg-red-900/30' },
  { id: 5, title: 'Global Trade - Cash flow riport Q4', date: '2024. 01. 08.', client: 'Global Trade Kft.', format: 'EXCEL', iconColor: 'text-emerald-500', bg: 'bg-emerald-50 dark:bg-emerald-900/30' },
];
      ...
      <div className="space-y-4">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm overflow-hidden divide-y divide-slate-100 dark:divide-slate-800">
          {recentReports.map((report) => (
            <div key={report.id} className="flex items-center justify-between p-4 hover:bg-slate-50/50 dark:hover:bg-slate-800/50 transition-colors">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">{report.date} • {report.client}</p>
                </div>
              </div>
