...
const InvoicesPage = () => {
  ...
  const filteredAndSortedInvoices = useMemo(() => {
    let filtered = invoices.filter(invoice => {
      ...
      // Direction filter
      if (filters.direction && filters.direction !== 'all' && invoice.invoice_direction !== filters.direction) {
        return false;
      }
    ...
    return filtered;
  }, [invoices, filters, sortField, sortDirection, partners]);
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 p-4 bg-muted/50 rounded-lg">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium">Irány</label>
                <Select
                  value={filters.direction}
                  onValueChange={(value) => setFilters(prev => ({ ...prev, direction: value }))}
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Minden irány" />
                  </SelectTrigger>
                  <SelectContent>
