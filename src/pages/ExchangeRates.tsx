      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="py-[4px]">Főbb devizák árfolyamai</CardTitle>
              <CardDescription>
                Bázis valuta: Magyar Forint (HUF)
              </CardDescription>
            </div>
            {lastUpdate && <Badge variant="outline" className="text-xs">
        ...
        <CardContent>
          {loading ? <div className="space-y-3">
              ...
              <TableBody>
                {rates.map(rate => <TableRow key={rate.currency} className="hover:bg-muted/50">
