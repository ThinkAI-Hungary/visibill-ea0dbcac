...
export const PATH_TO_MODULE: Record<string, AccountyModule> = {
  '/eaisybooks': 'portfolio',
  '/eaisybooks/missing-invoices': 'missing_invoices',
  '/eaisybooks/tax-calendar': 'tax_calendar',
  '/eaisybooks/reports': 'reports',
  '/eaisybooks/approval-queue': 'approval_queue',
  '/eaisybooks/alerts': 'alerts',
  '/eaisybooks/nav-deadlines': 'nav_deadlines',
  '/eaisybooks/payroll-portfolio': 'payroll',
  '/eaisybooks/onboarding': 'onboarding',
  '/eaisybooks/tao': 'tao',
  '/eaisybooks/settings': 'settings',
  '/eaisybooks/tickets': 'tickets',
  '/eaisybooks/ai-assistant': 'ai_assistant',
  '/eaisybooks/help': 'help',
  '/eaisybooks/profile/settings': 'profile',
  '/eaisybooks/admin/audit': 'admin_audit',
  '/eaisybooks/admin/gdpr': 'admin_gdpr',
  '/eaisybooks/admin/templates': 'admin_templates',
  '/eaisybooks/admin/job-codes': 'admin_job_codes',
  '/eaisybooks/admin/tax-parameters': 'admin_tax_params',
  '/eaisybooks/admin/legal-updates': 'admin_legal',
  '/eaisybooks/admin/office-settings': 'admin_office',
  '/eaisybooks/admin/permissions': 'admin_permissions',
  '/eaisybooks/admin/accountants': 'admin_accountants',
};
